...
export function PlaceholdersAndVanishInput({
  ...
  return (
    (<form
      className={cn(
        `md:w-[25vw] w-[85vw] relative dark:bg-zinc-800 h-12 rounded-lg  overflow-hidden transition duration-200`,
        value && "bg-gray-50"
      )}
      ...
      <input
        ...
        className={cn(
          "w-[100%] relative text-sm sm:text-base focus:outline-2 z-50 border-2 dark:text-white bg-transparent text-black h-full rounded-lg  focus:outline-[#C94C73] focus:ring-0 pl-4 sm:pl-7 pr-20",
